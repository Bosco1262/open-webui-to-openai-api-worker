...
export const I18N = {
    'zh-CN': {
      ...
      'health.sub_ok': '最近成功：{ago}',
      'health.sub_degraded': '有模型未探清，按退避重试；最近成功：{ago}',
      'health.sub_auth': '连续被拒 {n}/{max} 次后将暂停探测',
      'health.sub_suspended': '自 {since} 起暂停；重新导入 Session 或点「立即探测」后恢复',
      'health.sub_no_session': '导入 Session 后开始探测',
      'health.never': '从未成功',
      'health.ago_now': '刚刚',
      'health.ago_minutes': '{n} 分钟前',
      'health.ago_hours': '{n} 小时前',
      'health.ago_days': '{n} 天前',
      'health.cached': '已缓存 {n} 个模型',
    ...
    'en': {
      ...
      'health.sub_ok': 'Last success: {ago}',
      'health.sub_degraded': 'Models unresolved, retrying with backoff; last success: {ago}',
      'health.sub_auth': 'Probing pauses after {n}/{max} consecutive rejections',
      'health.sub_suspended': 'Paused since {since}; re-import the session or press "Probe now" to resume',
      'health.sub_no_session': 'Probing starts once a session is imported',
      'health.never': 'never',
      'health.ago_now': 'just now',
      'health.ago_minutes': '{n} min ago',
      'health.ago_hours': '{n} h ago',
      'health.ago_days': '{n} d ago',
      'health.cached': '{n} models cached',
